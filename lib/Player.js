...
class Player extends Entity {
  constructor(socketId, name) {
    super([2000, 2000], null, null, null, 30)
  ...
  updateOnInput(input) {
    if (input.WHEEL_ORIENTATION !== null) {
  ...
  update() {
    ...
    this.position[0] = Util.bound(this.position[0], 0, 5000)
    this.position[1] = Util.bound(this.position[1], 0, 5000)
  }
